   	  	...
   	  	// console.log(content.id);
   	  	 ...
   	  	 for(var j=0;j<_store.getCount();j++){
   	  	     ...
   	  	     if(this.editorUi.editor.editortype=='appbuild'){
   	  	       content.appendChild(this.createVertexTemplate('html=1;image;image=images/etlwidget/'+r.get('FUNC_ICON'), 165,150,r.get('WIDGETNAME'),r.get('FUNC_CODE')))
   	  	     }
   	  	     else{
   	  	     	content.appendChild(this.createVertexTemplate('image;image=images/etlwidget/'+r.get('FUNC_ICON'), 52,40,r.get('WIDGETNAME'),r.get('FUNC_CODE')))
   	  	    };
   	  	 }
