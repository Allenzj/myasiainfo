   ...
   var showAgentInfoDialog=function(acttype){
		...
		var formcfg = ({
			...
			items : [ 
				...
				{type:'combox',label:'所在主机',notNull:'N',fieldName :'HOST_NAME',storesql: getComboxStoreSql('SELECT HOST_NAME AS K ,HOSTCNNAME AS V FROM dp_host_config','METADBS'),width:300},
